...
public class Bookingscar extends JFrame implements ActionListener {
  ...
  Object rows[][] = { { "", "", "", "", "", "" }, { "", "", "", "", "", "" }, { "", "", "", "", "", "" },
  		{ "", "", "", "", "", "" }, { "", "", "", "", "", "" } };
  String columns[] = { "Driver N ID","Licence car ID", "Car Type", "Car Model", "Car Colour", "Car Fee", "Car Status" };
...
//Driver Code 
 ...
 { 
     Bookingscar renting = new Bookingscar(); 
 } 
}
